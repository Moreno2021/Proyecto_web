    ...
    <div class="modal-content">
      ...
      <form action="{{route('plandework.update',$pdt->id_pdt)}}" method="post" enctype="multipart/form-data" onsubmit="return validarFormularioEdicion('{{ $pdt->id_pdt }}')">
        ...
        <div class="modal-body">
          <div class="mb-3">
            <label for="idProyectosE" class="form-label">Proyecto Asociado</label>
          ...
          <div class="mb-3">
            <label for="idAsesoresE" class="form-label">Asesor a Cargo</label>
          ...
          <div class="mb-3">
            <label for="NombreActividadE" class="form-label">Nombre de la Actividad</label>
          ...
          <div class="mb-3">
            <label for="FechaInicioE" class="form-label">Fecha y Hora de Inicio</label>
          ...
          <div class="mb-3">
            <label for="FechaFinE" class="form-label">Fecha y Hora de Fin</label>
