            ...
            <table class="table">
                <thead class="bg-primary text-white">
                    <tr>
                        ...
                        @role('Editar Asesores|Eliminar Asesores')
                ...
                <tbody>
                    ...
                    <tr class="">
                        ...
                        @endrole
                        @role('Eliminar Asesores')
                        <button type="button" class="btn btn-outline-danger" onclick="confirmarEliminacion('{{ $asesor->id_asesor }}')">
                    ...
                    @include('asesores.info')
                    @endforeach
                </tbody>
            </table>
        </div>
        @include('asesores.create')
    </div>
    <div class="col-md-1"></div>
</div>
@endrole
